...
재구성한 단계입니다. 날짜는 각 단계를 대표하는 커밋이 들어간 시점입니다. 여러 단계가 깔끔하게
...
2. **Socket.IO → GraphQL 메시징 마이그레이션** (2026-01-22 ~ 2026-06-11) — 가장 오래 걸린
   ...
   시작했습니다("Testing Socket through GraphQL real time responses"). `sendMessage`의 초기
...
3. **배포 인프라** (2026-04-22 ~ 2026-05-27) — CI/CD 워크플로우는 2026-04-22에, Docker Compose는
   2026-05-01에 추가되었습니다. 이어진 모노레포 재구성(2026-05-13 ~ 2026-05-27)을 거쳐 지금의
