...
- Timeout — advisory: calls to external dependencies (Gemini API) should carry an
  explicit timeout; a hanging external call holds acquired resources for its full duration.
